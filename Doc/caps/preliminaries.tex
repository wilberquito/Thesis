...
There are a considerable amounts of different metrics that can be computed for a model prediction but I'll present the essential metrics used in the thesis. \\
