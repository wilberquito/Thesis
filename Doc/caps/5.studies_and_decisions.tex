...
\begin{itemize}
  ...
  \item \textbf{CUDA}
    ...
    PyTorch (\textit{Figure \ref{fig:pytorch-logo}}) is an open-source machine
  ...
  \item \textbf{OpenCV}
    ...
    OpenCV (\textit{Figure \ref{fig:opencv-logo}}) allows developers to read,
  ...
  \item \textbf{Matplotlib}
    ...
    Matplotlib (\textit{Figure \ref{fig:matplotlib-logo}}) is a widely-used
  ...
  \item \textbf{FastAPI}
    ...
    FastAPI (\textit{Figure \ref{fig:fastapi-logo}}) is a modern,
  ...
  \item \textbf{SvelteKit}
    ...
    SvelteKit (\textit{Figure \ref{fig:sveltekit-logo}}) is a high-performance
  ...
  \item \textbf{Docker}
    ...
    Docker (\textit{Figure \ref{fig:docker-logo}}) is an open-source platform
  ...
  \item \textbf{Podman}
    ...
    Podman (\textit{Figure \ref{fig:podman-logo}}) is designed to manage
  ...
  \item \textbf{Git}
    ...
    Git (\textit{Figure \ref{fig:git-logo}}) is a distributed version control
