...
\begin{figure}[H]
  ...
  \resizebox{0.8\textwidth}{!}{%
    ...
    \caption[AI Sub-Specialists]{\textit{AI Sub-Specialists. Note that these subfields often intersect and combine. Illustration by Author}}
...
Stochastic Gradient Descent (SGD) work similar to the Gradient Descent but the weight
