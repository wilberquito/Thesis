...
\titlegraphic {
  \begin{tikzpicture}[overlay,remember picture, opacity=0.15,]
    \node[] at (0, 2.4){ \includegraphics[width=0.63\textwidth]{udglogo.png} };
    \node[] at (-4, 0){ \includegraphics[width=0.1\textwidth]{accenturelogo.png} };
    \node[] at (4.1, 0){ \includegraphics[width=0.1\textwidth]{vicoroblogo.png} };
  \end{tikzpicture}
}
