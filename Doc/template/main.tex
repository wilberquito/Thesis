...
\include{caps/summary}

\include{caps/gratitudes}
...
\include{caps/state_of_the_art}

\include{caps/problem_domain}

\include{caps/preliminaries}

\include{caps/studies_and_decisions}

\include{caps/planing_and_methodology}

\include{caps/methodological_contribution}

\include{caps/results}

\include{caps/conclusions_and_future_work}
