...
\include{prephase/1.summary}

\include{prephase/2.gratitude}
...
\include{caps/1.introduction}

\include{caps/2.state_of_the_art}

\include{caps/3.problem_domain}

\include{caps/4.preliminaries}

\include{caps/5.studies_and_decisions}

\include{caps/6.planing_and_methodology}

\include{caps/7.methodological_contribution}

\include{caps/8.results}

\include{caps/9.conclusions_and_future_work}
...
\include{appendices/manual_installation.tex}
\end{appendices}
